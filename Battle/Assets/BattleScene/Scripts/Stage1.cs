...
public class Stage1 : MonoBehaviour
{
    ...
    public void Round(int r)
    {
        ...
        else if (r == 10)
        {
            ...
            aiOpponent.AddEnemy(128, 0, 3, 100);
            aiOpponent.AddEnemy(127, 2, 3, 100);
        ...
        {
            aiOpponent.AddEnemy(133, 6, 3, 100);
            aiOpponent.AddEnemy(131, 4, 3, 100);
            aiOpponent.AddEnemy(132, 0, 3, 100);
            aiOpponent.AddEnemy(132, 2, 3, 100);
            aiOpponent.AddEnemy(130, 5, 2, 100);
            aiOpponent.AddEnemy(130, 3, 2, 100);
        ...
        {
            aiOpponent.AddEnemy(139, 6, 3, 100);
            ...
            aiOpponent.AddEnemy(137, 0, 2, 100);
        }
        else if (r == 26)
        {
        ...
        else if (r == 30)
        {
            ...
            aiOpponent.AddEnemy(139, 0, 3, 100);
            aiOpponent.AddEnemy(141, 2, 3, 100);
            aiOpponent.AddEnemy(141, 5, 2, 100);
            aiOpponent.AddEnemy(141, 3, 2, 100);
            aiOpponent.AddEnemy(141, 1, 2, 100);
